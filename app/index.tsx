    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.card}>
        <View style={styles.header}>
          ...
          <Text style={styles.hp}>❤️ HP: 98</Text>
        </View>
        ...
        <Text style={styles.sectionText}>Thunderbolt, Thunder, and Volt Tackle, as well as moves like Quick Attack, Iron Tail, and Nuzzle.</Text>
      ...
      <View style={styles.card}>
        <View style={styles.header}>
          <Text style={styles.name}>Megatile</Text>
          <Text style={styles.hp}>❤️ HP: 92</Text>
        </View>
        ...
        <Text style={styles.sectionLabel}>Moves:</Text>
        <Text style={styles.sectionText}>Leaf Blade, Dragon Claw, and Dragon Pulse</Text>

        <Text style={styles.sectionLabel}>Weakness:</Text>
        <Text style={styles.sectionText}>Ice-type attacks</Text>
      </View>
